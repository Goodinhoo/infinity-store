      ...
      <div className="flex flex-col gap-4">
        {products.length === 0 ? (
          <div className="gale-panel p-12 text-center text-gray-400 border border-white/10 rounded-2xl">
            ...
            <p className="text-xs text-gray-500 mt-1">Clica no botão &quot;Novo Produto&quot; acima para adicionares o teu primeiro item.</p>
          </div>
        ) : (
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="font-bold text-white leading-tight mt-1 flex items-center gap-2">
                      {product.name}
                      {product.isFeatured && (
                        <span className="w-2 h-2 rounded-full bg-yellow-400 shrink-0" title="Destaque"></span>
                      )}
                    </p>
